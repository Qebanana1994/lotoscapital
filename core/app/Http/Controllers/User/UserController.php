...
class UserController extends Controller
{
    ...
    public function userDataSubmit(Request $request)
    {
        ...
        $validationRule['mobile']       = 'nullable|regex:/^([0-9]*)$/';
        //$validationRule['username']     = 'required|unique:users|min:6';
        $validationRule['mobile_code']  = 'nullable|required_with:mobile|in:' . $mobileCodes;
        $validationRule['country_code'] = 'nullable|in:' . $countryCodes;
        $validationRule['country']      = 'nullable|in:' . $countryCodes;
