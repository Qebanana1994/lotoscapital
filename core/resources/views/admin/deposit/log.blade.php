                    ...
                    <table class="table table--light style--two">
                        ...
                        @forelse($deposits as $deposit)
                            ...
                            <tr>
                                ...
                                <td>@if($deposit->status == 2)
<button class="btn btn-outline--success btn-sm ms-1 confirmationBtn" data-id="{{ $deposit->id }}" data-amount="{{ showAmount($deposit->amount) }} {{ __($general->cur_text) }}"><i class="las la-check-double"></i>
                                        @lang('Approve')
                                    </button>
