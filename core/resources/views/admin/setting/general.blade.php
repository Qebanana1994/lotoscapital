                    ...
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 col-sm-6">
                                ...
                                <select value="{{ str_replace(["'"], '', $general->timezone) }}" class="select2-basic" name="timezone">
                                    @foreach ($timezones as $timezone)
                                        <option {{str_replace(["'"], '', $general->timezone) == @$timezone ? 'selected' : ''}} value="'{{ @$timezone }}'">{{ __($timezone) }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-md-4 col-sm-6">
                            ...
                            <div class="col-md-6 col-sm-8">
                                <div class="form-group">
                                    <label>@lang('Start Project')</label>
                                    <div class="input-group">
                                        <input class="form-control bal-charge" type="datetime-local" name="start_of_project" required value="{{ $general->start_of_project }}">
                                        <div class="input-group-text">{{ $general->start_of_project }}</div>
                                    </div>
                                </div>
                            </div>
                            <div></div>
