        ...
        <ul class="nav-header-link d-flex flex-wrap gap-2">
            <li>
                ...
                <div class="dropdown-wrapper">
                    ...
                    <ul class="links">
                        <li><a href="{{ route('user.profile.setting') }}"><i class="las la-user"></i> Профиль</a></li>
                        <li><a href="{{ route('user.change.password') }}"><i class="las la-key"></i> Сменить пароль</a></li>
                        <li><a href="{{ route('user.logout') }}"><i class="las la-sign-out-alt"></i> Выйти</a></li>
                    </ul>
                </div>
            </li>
        </ul>
