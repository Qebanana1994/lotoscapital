                ...
                <div class="col-xl-6 col-lg-7 col-md-8">
                    ...
                    <form action="{{ route('user.register') }}" method="POST" class="verify-gcaptcha account-form">
                        <div class="col-12 mt-4">
                            <div class="mb-4">
                                <h4 class="mb-2">Создать и войти одним кликом через соцсети</h4>
                            </div>
                        ...
                        <div class="row">
                            ...
                            @endif
                                <input type="hidden" name="register-reference" id="register-reference">
...
@push('script')
    <script>
        "use strict";
        (function($) {
            $('#register-reference').val(localStorage.getItem('reference'));
