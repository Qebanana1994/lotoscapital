    ...
    <div class="dashboard-inner">
        <div class="mb-4">
            <div class="d-flex justify-content-between">
                <h3 class="mb-2">Ваша история вкладов</h3>
                <span>
                    <a href="{{ route('user.deposit.index') }}" class="btn btn--secondary btn--smd">Инвестировать сейчас <i class="las la-long-arrow-alt-right"></i></a>
                </span>
            </div>
        </div>
