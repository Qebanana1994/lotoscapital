...
<div class="dashboard-inner">
    ...
    <div class="row gy-4">
        <div class="col-md-12">
            <div class="card mb-3">
                <div class="card-body">
                    <h4 class="mb-1">Приглашайте и получайте бонусы</h4>
                    <p class="mb-3">Компания <strong><i>{{ __($general->site_name) }}</i></strong> платит вам за приглашение ваших друзей знакомых и партнеровю 10% за каждый вклад лично приглашенного</p>
                    <div class="copy-link">
