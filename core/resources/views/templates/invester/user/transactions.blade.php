            ...
            <div class="flex-grow-1">
                <div class="custom-input-box">
                    ...
                    <select name="wallet_type" onChange="window.location.href=this.value">
                        <option value={{queryBuild('wallet','')}}>Все</option>
            ...
            <div class="flex-grow-1">
                <div class="custom-input-box">
                    ...
                    <select name="trx_type" onChange="window.location.href=this.value">
                        ...
                        <option value="{{queryBuild('trx_type','%2B')}}" @selected(request()->trx_type == '+')>Приход</option>
                        <option value="{{queryBuild('trx_type','-')}}" @selected(request()->trx_type == '-')>Расход</option>
                    </select>
                </div>
            </div>
            <div class="flex-grow-1">
                <div class="custom-input-box">
                    ...
                    <select name="remark" onChange="window.location.href=this.value">
                        <option value="{{ queryBuild('remark','') }}">Любая</option>
