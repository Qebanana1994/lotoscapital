                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap justify-content-between align-items-center">
                            <div>
                                ...
                                <h4 class="text--base">{{ $general->cur_sym }}{{ showAmount(auth()->user()->invests->sum('amount')) }}
                                </h4>
                            </div>
                            <div>
                                <p class="mb-2 fw-bold">@lang('Total Profit')</p>
                                <h4 class="text--base">{{ $general->cur_sym }}{{ showAmount(auth()->user()->transactions()->where('remark', 'interest')->sum('amount')) }}
                                </h4>
                            </div>
                        </div>
                        <div class="d-flex flex-wrap justify-content-between mt-3 mt-sm-4 gap-2">
                            ...
                            <a href="{{ route('user.withdraw') }}" class="btn btn--sm btn--base">@lang('Withdraw Now') <i
                                    class="las la-arrow-right fs--12px ms-1"></i></a>
                        </div>
                    </div>
                </div>
...
{{--                            </div>--}}
{{--                        @else--}}
{{--                            <h3 class="text-center mt-3">@lang('No Investment Found Yet')</h3>--}}
{{--                        @endif--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
